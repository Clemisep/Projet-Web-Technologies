...
extends Table {
    ...
    public static SkillInstance addSkillInstance(User.Student student, Skill skill, long level) throws SQLException {
    	try(PreparedStatement p = Utils.prepareStatementWithKey((String)"INSERT INTO skill_instance(id_skill, id_student, level, tutor_comment, student_comment) VALUES(?,?,?,?,?)")) {
