...
<body>
	...
	<div>
		...
		<div ng-show="skmCtrl.show" class="box box-primary">
			...
			<form>
				<label>Nouveau Type d'APP : </label> <input type="text"
					ng-model="skmCtrl.skillInput"> <br>
				<br> <label>Nouvelle sous-compétence : </label> <input
					type="text" ng-model="skmCtrl.subSkillInput"> <br>
				<br> <input type="button"
					class="btn btn-sm btn-info btn-flat pull-left"
					value="Ajouter une sous-compétence"
					ng-click="skmCtrl.addSubSkill()" /> <br>
				<br>
			</form>
		</div>
		...
		<div>
			<button
				class="btn btn-sm btn-info btn-flat pull-left">Ajouter un
				type d'APP</button>
		</div>
