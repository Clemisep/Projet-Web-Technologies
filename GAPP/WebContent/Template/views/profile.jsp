							...
							<tr>
								...
								%>
									<p>
										...
										Groupe d'APP : <%=student.getGroupApp()%><br /> Compétences :<br />
										<%
						...
						<table id="table1"
							...
							<tbody>
								...
								<tr>
									...
									<input type="text" hidden value="<%= skill.getId() %>" name="id_skill">
									<input type="text" hidden value="<%= student.getId() %>" name="id_student">
